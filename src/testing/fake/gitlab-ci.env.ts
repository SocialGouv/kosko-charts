export const project = (
  ...
  const dev = {
    ...
    CI_COMMIT_TAG: "",
    CI_ENVIRONMENT_NAME: "master-dev42",
    CI_ENVIRONMENT_SLUG: "master-dev42",
    CI_ENVIRONMENT_URL: `https://master-dev42-${CI_PROJECT_NAME}.dev42.fabrique.social.gouv.fr`,
    KUBE_INGRESS_BASE_DOMAIN: "dev42.fabrique.social.gouv.fr",
    KUBE_NAMESPACE: `${CI_PROJECT_NAME}-85-master-dev42`,
    PRODUCTION: "",
  };
  ...
  const preprod = {
    ...
    CI_ENVIRONMENT_NAME: "preprod-dev42",
    CI_ENVIRONMENT_SLUG: "preprod-dev42",
    CI_ENVIRONMENT_URL: `https://preprod-${CI_PROJECT_NAME}.dev42.fabrique.social.gouv.fr`,
    KUBE_INGRESS_BASE_DOMAIN: "dev42.fabrique.social.gouv.fr",
    KUBE_NAMESPACE: `${CI_PROJECT_NAME}-85-preprod-dev42`,
    PRODUCTION: "",
  };
