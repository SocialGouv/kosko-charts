...
// renovate: datasource=docker depName=registry.gitlab.factory.social.gouv.fr/socialgouv/docker/wait-for-http versioning=4.6.0
const SOCIALGOUV_DOCKER_WAIT_FOR_HTTP_VERSION = "4.6.0";
