...
// renovate: datasource=docker depName=socialgouv/docker/azure-db registryUrl=registry.gitlab.factory.social.gouv.fr versioning=2.6.1
const SOCIALGOUV_DOCKER_AZURE_DB_VERSION = "2.6.1";
