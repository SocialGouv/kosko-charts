...
// renovate: datasource=docker depName=registry.gitlab.factory.social.gouv.fr/socialgouv/docker/azure-db versioning=4.9.0
const SOCIALGOUV_DOCKER_AZURE_DB_VERSION = "4.9.0";
