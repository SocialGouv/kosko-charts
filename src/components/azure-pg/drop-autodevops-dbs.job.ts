...
// renovate: datasource=docker depName=registry.gitlab.factory.social.gouv.fr/socialgouv/docker/azure-db versioning=4.2.1
const SOCIALGOUV_DOCKER_AZURE_DB_VERSION = "4.2.1";
