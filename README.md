...
```sh
$ npx degit "SocialGouv/kosko-charts/templates/sample#v9.1.2" .k8s
$ yarn --cwd .k8s
# on GitLab
...
$ npx degit "SocialGouv/kosko-charts/templates/hasura#v9.1.2" .k8s

# For [nginx](https://nginx.org/)
$ npx degit "SocialGouv/kosko-charts/templates/nginx#v9.1.2" .k8s

# For [pgweb](https://sosedoff.github.io/pgweb/)
$ npx degit "SocialGouv/kosko-charts/templates/pgweb#v9.1.2" .k8s

# For [redis](https://redislabs.com/)
$ npx degit "SocialGouv/kosko-charts/templates/redis#v9.1.2" .k8s
```
...
$ npx degit "SocialGouv/kosko-charts/templates/testing#v9.1.2" .k8s
```
