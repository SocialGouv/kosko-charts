...
```sh
$ npx degit "SocialGouv/kosko-charts/templates/sample#v5.2.0-alpha.4" .k8s
$ yarn --cwd .k8s
# on GitLab
...
$ yarn exec degit "SocialGouv/kosko-charts/templates/autodevops#v5.2.0-alpha.4" .k8s
...
$ npx degit "SocialGouv/kosko-charts/templates/hasura#v5.2.0-alpha.4" .k8s

# For [nginx](https://nginx.org/)
$ npx degit "SocialGouv/kosko-charts/templates/nginx#v5.2.0-alpha.4" .k8s

# For [pgweb](https://sosedoff.github.io/pgweb/)
$ npx degit "SocialGouv/kosko-charts/templates/pgweb#v5.2.0-alpha.4" .k8s

# For [redis](https://redislabs.com/)
$ npx degit "SocialGouv/kosko-charts/templates/redis#v5.2.0-alpha.4" .k8s
```
...
$ npx degit "SocialGouv/kosko-charts/templates/testing/__tests__#v5.2.0-alpha.4" .k8s/__tests__
$ npx degit "SocialGouv/kosko-charts/templates/testing/package.json#v5.2.0-alpha.4" .k8s/package.json
```
