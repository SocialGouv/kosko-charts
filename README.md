...
```sh
$ npx degit "SocialGouv/kosko-charts/templates/sample#v7.0.1" .k8s
$ yarn --cwd .k8s
# on GitLab
...
$ npx degit "SocialGouv/kosko-charts/templates/hasura#v7.0.1" .k8s

# For [nginx](https://nginx.org/)
$ npx degit "SocialGouv/kosko-charts/templates/nginx#v7.0.1" .k8s

# For [pgweb](https://sosedoff.github.io/pgweb/)
$ npx degit "SocialGouv/kosko-charts/templates/pgweb#v7.0.1" .k8s

# For [redis](https://redislabs.com/)
$ npx degit "SocialGouv/kosko-charts/templates/redis#v7.0.1" .k8s
```
...
$ npx degit "SocialGouv/kosko-charts/templates/testing#v7.0.1" .k8s
```
