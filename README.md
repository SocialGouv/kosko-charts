...
```sh
$ npx degit "SocialGouv/kosko-charts/templates/sample#v4.0.0" .k8s
$ yarn --cwd .k8s
# on GitLab
...
$ npx degit "SocialGouv/kosko-charts/templates/hasura#v4.0.0" .k8s

# For [nginx](https://nginx.org/)
$ npx degit "SocialGouv/kosko-charts/templates/nginx#v4.0.0" .k8s

# For [pgweb](https://sosedoff.github.io/pgweb/)
$ npx degit "SocialGouv/kosko-charts/templates/pgweb#v4.0.0" .k8s

# For [redis](https://redislabs.com/)
$ npx degit "SocialGouv/kosko-charts/templates/redis#v4.0.0" .k8s
```
...
$ npx degit "SocialGouv/kosko-charts/templates/testing/__tests__#v4.0.0" .k8s/__tests__
$ npx degit "SocialGouv/kosko-charts/templates/testing/package.json#v4.0.0" .k8s/package.json
```
